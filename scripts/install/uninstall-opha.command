#!/usr/bin/env bash
# =============================================================================
# Opha — désinstalleur macOS — packaging V1 / P.3
# =============================================================================
# Arrête et supprime les containers Opha. Demande explicitement quoi faire des
# volumes (Postgres, documents, keystore eHealth, certs Caddy) — par défaut
# on PRÉSERVE pour éviter une perte de données accidentelle.
#
# Le dossier ~/Opha/ et le fichier .env restent en place sauf si demandé.
# =============================================================================
